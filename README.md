...
## 整体架构
<img src="./img/img1.png" width="720" hegiht="720" align=center />
...
### 1.2、组件化开发
代码是死的，产品是活的。在日常开发中，各种各样频繁变动的需求，给开发带来了不小的麻烦。为了尽量把代码写“活”，所以出现了设计模式。但光有设计模式，还是很难满足产品BT的需求。
...
<img src="./img/img2.png" width="640" hegiht="640" align=center />
### 1.3、MVVM模式 + 组件化
关说理论没用，来点实际的东西，这里要提两个重要的框架。
...
**MVVMHabit + ARouter**：MVVM模式 + 组件化方案，前者是设计模式，后者是方案架构，两者并用，相得益彰。
## 2、项目搭建
